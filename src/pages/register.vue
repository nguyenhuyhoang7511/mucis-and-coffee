...
const schema = yup.object({
  email: yup
    ...
    .matches(/@gmail\.com$/, "Email phải có định dạng là @gmail.com"),
  ...
  password: yup
    ...
    .matches(
      /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/,
      "Mật khẩu yêu cầu chứa cả chữ và số"
    ),
  confirmPassword: yup
    .string()
  ...
  agree: yup
    .boolean()
    .oneOf([true], "Bạn cần phải đồng ý với các điều kiện và điều khoản để tiếp tục."),
});
  ...
  <div class="auth-wrapper d-flex align-center justify-center pa-4 container-card-login">
    ...
    <VCard class="auth-card pa-4 pt-7 login-form-card" max-width="600" height="75%">
      ...
      <VCardText class="pt-2">
        <h3 class="mb-0 mt-5">Hãy tiến hành tạo tài khoản để trải nghiệm hệ thống</h3>
      </VCardText>
